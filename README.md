...
- **GalleryActivity**: 
  ...
  - deleteQuiz() locates and presses the remove button on the first item in the gallery, then checks how many items are left. Since the gallery is initialized with 3 quizzes, 2 should remain after deletion.
